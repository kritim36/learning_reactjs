...
const EditBlog = () => {
  ...
  const editBlog = async (e)=>{
    e.preventDefault()
    const response = await axios.put("https://6527d104931d71583df16f7b.mockapi.io/blogs/" + id,blog)
  ...
  const fetchBlog = async ()=>{
    const response = await axios.get("https://6527d104931d71583df16f7b.mockapi.io/blogs/" + id)
    if(response.status == 200){
